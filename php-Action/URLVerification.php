...
if(MySQLConnection::isExist($URL_ID, $PageIdentifier)){
  echo "<iframe id='EV-Iframe' style='width:100%; min-height: 400px; border:none;' scrolling='no' src='http://evcommentservice.ga/Comment.php?db=$URL_ID&pageID=$PageIdentifier'></iframe>";
}
