...
if(MySQLConnection::isExist($URL_ID, $PageIdentifier)){
  echo "<iframe style='width: 100%; border: none; height='100vh'; overflow-y:hidden;' src='http://evcommentservice.ga/Comment.php?db=$URL_ID&pageID=$PageIdentifier'></iframe>";
}
